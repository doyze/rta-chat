...
gb7(d){return"Fjern"},
gm6(){return"Importer nu"},
gm4(){return"Importer emojis"},
gm5(){return"Importer fra .zip fil"},
glN(){return"Eksport\xe9r Emote-pakke som .zip-fil"},
gnG(d){return"Erstat"},
gex(){return"Om"},
h9(d){return"Om "+d},
...
gln(){return"Bekr\xe6ft din Matrix-ID for at slette din konto."},
kF(d){return"Den burde v\xe6re "+d},
ghh(){return"Tilf\xf8j til gruppe"},
ghi(){return"Admin"},
ghj(){return"alias"},
ghk(){return"All"},
glh(){return"Opgrader dette rum til den givne rumversion"},
glc(){return"Send googly-eyes"},
glb(){return"Send et varmt smil"},
gld(){return"Send et kram"},
k0(d){return d+" sender dig googly-eyes"},
lx(d){return d+" sender dig et varmt smil"},
m3(d){return d+" krammer dig"},
...
(a=>{a["WsVERgM4yL9UXavTRv3utdJj54A="]=a.current})($__dart_deferred_initializers__);